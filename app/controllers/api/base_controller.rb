module Api
  class BaseController < ActionController::API
    ...
    rescue_from Exceptions::InvalidCredentials, with: :render_error_response
    rescue_from Exceptions::RegistrationError, with: :render_error_response
    rescue_from Exceptions::ResetPasswordError, with: :render_error_response
    ...
    def render_error_response(exception)
      render json: { success: false, message: exception.message }, status: :unprocessable_entity
    end
