...
ActiveRecord::Schema[7.0].define(version: 2022_09_27_042853) do
  ...
  create_table "recipe_reviews", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "recipe_id"
    t.text "review"
    ...
    t.index ["user_id", "recipe_id"], name: "index_recipe_reviews_on_user_id_and_recipe_id", unique: true
